> [!IMPORTANT]
> **Experimental development fork** — the official, stable OASiS lives at
> **<https://github.com/Hereon-InstituteMS/OASiS>**.
> This repository is the working mirror where new capabilities are developed and
> stress-tested before they graduate upstream. Expect rough edges; for anything
> citable or production use, go to the official repository.
...
(For the stable version, clone `https://github.com/Hereon-InstituteMS/OASiS.git` instead.)
