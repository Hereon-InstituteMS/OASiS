#!/bin/bash
# Tier-2 for dealii hyperelasticity#8 -- probe "mapping_q_eulerian" of the shared
...
exec bash "$HERE/../_shared/run.sh" hyperelastic_family release mapping_q_eulerian
