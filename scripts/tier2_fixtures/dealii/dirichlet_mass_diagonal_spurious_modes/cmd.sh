#!/bin/bash
# Tier-2 for dealii eigenvalue#2 — probe "dirichlet_spurious_modes" of the shared eigenvalue translation unit
...
exec bash "$HERE/../_shared/run.sh" eigen_family release dirichlet_spurious_modes
