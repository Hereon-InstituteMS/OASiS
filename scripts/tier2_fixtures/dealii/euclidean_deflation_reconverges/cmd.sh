#!/bin/bash
# Tier-2 for dealii eigenvalue#1 — probe "deflation_inner_product" of the shared eigenvalue translation unit
...
exec bash "$HERE/../_shared/run.sh" eigen_family release deflation_inner_product
