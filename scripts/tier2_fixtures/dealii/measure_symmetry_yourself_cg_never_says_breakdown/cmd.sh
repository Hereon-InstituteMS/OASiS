#!/bin/bash
# Tier-2 for dealii linear_elasticity#8 — probe "symmetry_measure" of the shared elasticity translation
...
exec bash "$HERE/../_shared/run.sh" elasticity_family release symmetry_measure
