#!/bin/bash
# Tier-2 for dealii hyperelasticity#10 -- probe "incremental_constraints" of the shared
...
exec bash "$HERE/../_shared/run.sh" hyperelastic_family release incremental_constraints
