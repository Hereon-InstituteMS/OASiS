#!/bin/bash
# Tier-2 for dealii heat#0 — probe "reassemble_cost" of the shared transient-heat translation
...
exec bash "$HERE/../_shared/run.sh" heat_family release reassemble_cost
