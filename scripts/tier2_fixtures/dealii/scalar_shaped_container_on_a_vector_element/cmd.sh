#!/bin/bash
# Tier-2 for dealii hyperelasticity#11 -- probe "fesystem_gradient_containers" of the shared
...
exec bash "$HERE/../_shared/run.sh" hyperelastic_family release fesystem_gradient_containers
