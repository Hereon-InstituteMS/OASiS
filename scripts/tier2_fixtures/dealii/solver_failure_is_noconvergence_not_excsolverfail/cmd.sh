#!/bin/bash
# Tier-2 for dealii linear_elasticity#0 — probe "noconvergence_text" of the shared elasticity translation
...
exec bash "$HERE/../_shared/run.sh" elasticity_family release noconvergence_text
