#!/bin/bash
# Tier-2 for dealii linear_elasticity#1 — probe "lame_swap" of the shared elasticity translation
...
exec bash "$HERE/../_shared/run.sh" elasticity_family release lame_swap
