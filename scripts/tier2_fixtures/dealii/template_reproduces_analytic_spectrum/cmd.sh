#!/bin/bash
# Tier-2 for dealii eigenvalue#8 — probe "template_reference_values" of the shared eigenvalue translation unit
...
exec bash "$HERE/../_shared/run.sh" eigen_family release template_reference_values
