#!/bin/bash
# Tier-2 for dealii hyperelasticity#7 -- probe "ad_energy_functional" of the shared
...
exec bash "$HERE/../_shared/run.sh" hyperelastic_family release ad_energy_functional
