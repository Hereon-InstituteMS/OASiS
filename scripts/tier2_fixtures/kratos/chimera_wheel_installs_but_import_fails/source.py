"""Tier-2: the Chimera wheel installs and then fails to import.

The distinguishing observation is the message: an ImportError
naming a missing shared object, not a
ModuleNotFoundError. A fixture that only asserted 'does not
import' would not tell the two apart, and the difference is the
...
CASES = [('ChimeraApplication', False), ('FluidDynamicsApplication', True)]
