"""Tier-2: modern contact IS pip-installable; only the legacy apps are absent.

The claim's operative advice — 'build from source, there is no
pip path' — is wrong for the modern application
and right for the legacy ones. A reader who followed it would
build Kratos from source for no reason.
"""
...
CASES = [('ContactStructuralMechanicsApplication', True), ('ContactMechanicsApplication', False), ('SolidMechanicsApplication', False), ('StructuralMechanicsApplication', True)]
