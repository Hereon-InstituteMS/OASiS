"""Tier-2: both prerequisites and the coupling app import.

A dependency claim, checkable by import. The coupling
application is useless without both, and all three must live
in one interpreter.
...
CASES = [('DEMApplication', True), ('StructuralMechanicsApplication', True), ('DemStructuresCouplingApplication', True), ('NoSuchKratosApplication', False)]
if MUTATE:
