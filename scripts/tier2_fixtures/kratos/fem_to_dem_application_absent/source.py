"""Tier-2: FemToDem has no wheel for this interpreter.

An availability fact, checked by import. Both prerequisites are
present, so the failure is the application's own absence.
"""
...
CASES = [('FemToDemApplication', False), ('DEMApplication', True), ('StructuralMechanicsApplication', True)]
