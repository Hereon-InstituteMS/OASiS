"""Tier-2: all four FSI prerequisites import.

Two of the four are never named in the user-facing JSON, so a
reader has no reason to install them. The fixture states the
full set.
...
CASES = [('FluidDynamicsApplication', True), ('StructuralMechanicsApplication', True), ('MeshMovingApplication', True), ('MappingApplication', True), ('FSIApplication', True), ('NoSuchKratosApplication', False)]
if MUTATE:
