"""Tier-2: the four applications partitioned FSI needs all exist.

The claim is a hidden-dependency fact. What is checkable
without a full FSI run is that the two applications a reader
would omit are genuine importable modules that must be present.
"""
...
CASES = [('FSIApplication', True), ('MappingApplication', True), ('MeshMovingApplication', True), ('FluidDynamicsApplication', True), ('ContactMechanicsApplication', False)]
