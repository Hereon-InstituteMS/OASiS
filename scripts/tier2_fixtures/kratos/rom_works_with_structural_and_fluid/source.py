"""Tier-2: ROM coexists with the two applications it is meant to reduce.

The claim is about which applications ROM composes with. That
is an import fact: all three must load into one process.
...
CASES = [('RomApplication', True), ('StructuralMechanicsApplication', True), ('FluidDynamicsApplication', True), ('NoSuchKratosApplication', False)]
if MUTATE:
