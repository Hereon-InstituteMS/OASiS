"""Tier-2: SwimmingDEM is absent and installing it would downgrade the core.

The claim is about a version pin, and the safe way to hold it
is to assert the application stays out of a
10.4.3 stack while its prerequisites stay in.
"""
...
CASES = [('SwimmingDEMApplication', False), ('DEMApplication', True), ('FluidDynamicsApplication', True)]
