"""Tier-2: ThermalDEM is absent while its DEM prerequisite is present.

Checked by import so the assertion holds offline and describes
THIS build. The DEM positive control distinguishes a genuinely
missing wheel from an empty environment.
...
CASES = [('ThermalDEMApplication', False), ('DEMApplication', True)]
if MUTATE:
