"""Tier-2: the DEM base is present; ThermalDEM is not.

A dependency claim. The base imports, so the absence is
specific to the thermal application's own wheel.
...
CASES = [('DEMApplication', True), ('ThermalDEMApplication', False), ('NoSuchKratosApplication', False)]
if MUTATE:
