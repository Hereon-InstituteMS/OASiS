"""Tier-2: the prerequisite is present; TopologyOptimization itself is not.

The claim states a dependency. Checking it also exposes that
the application the dependency is FOR cannot be imported here,
which is the more useful fact for a reader.
"""
...
CASES = [('StructuralMechanicsApplication', True), ('TopologyOptimizationApplication', False), ('OptimizationApplication', True)]
