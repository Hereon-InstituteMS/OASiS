"""Tier-2: Trilinos absent from the pip stack; Metis available.

The distinguishing fact is asymmetric: one of the two named
infrastructure applications is pip-reachable and the other is
not. A fixture that only checked absence could pass on a host
...
CASES = [('TrilinosApplication', False), ('MetisApplication', True), ('LinearSolversApplication', True)]
if MUTATE:
