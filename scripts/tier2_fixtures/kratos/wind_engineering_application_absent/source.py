"""Tier-2: the WindEngineering application is not pip-reachable.

The dependency the claim names (RANSApplication) is present
while the application itself is not, which is what makes this
an availability fact about one wheel rather than about the
whole stack.
...
CASES = [('WindEngineeringApplication', False), ('RANSApplication', True), ('FluidDynamicsApplication', True)]
if MUTATE:
