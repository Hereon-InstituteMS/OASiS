...
The claim names two dependencies. Whether they are importable
is directly checkable, and pinning that they ARE while the
application is NOT locates the real obstacle.
"""
...
CASES = [('FluidDynamicsApplication', True), ('RANSApplication', True), ('WindEngineeringApplication', False)]
