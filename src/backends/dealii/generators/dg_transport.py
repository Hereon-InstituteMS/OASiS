...
KNOWLEDGE = {
    ...
    "pitfalls": [
        ...
        "entries. Signal: compare "
        "DynamicSparsityPattern::n_nonzero_elements() for the two "
        "builders — on this Release (NDEBUG) install there is NO "
        "exception to wait for. SparseMatrix::add(i, j, v) for an "
        "(i, j) "
