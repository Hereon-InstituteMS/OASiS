...
KNOWLEDGE = {
    ...
    "pitfalls": [
        ...
        "the theta=0.5 run with the term dropped settled on a value "
        "about 22 per cent too LARGE and stayed there — its distance "
        "from the backward-Euler answer did not shrink with dt at all. "
