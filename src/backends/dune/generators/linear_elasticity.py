    ...
    "linear_elasticity": {
        ...
        "pitfalls": [
            ...
            (
                ...
                "swapping the formulae for mu and lam "
                "gives Poisson ratio inverted in the "
                "discrete response — a tension test "
                "produces wrong-sign lateral contraction. "
                "Sanity check: pure shear should give "
                "nu-independent response. (Audit "
                "2026-06-02.)"
            ),
            (
