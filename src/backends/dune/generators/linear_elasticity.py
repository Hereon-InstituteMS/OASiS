    ...
    "linear_elasticity": {
        ...
        "pitfalls": [
            ...
            (
                ...
                "eps_xx = t/E, eps_yy = -nu*t/E. Comparing a "
                "plane-strain run against the plane-stress formula "
                "gives a ratio of 1/(1-nu^2) ~ 1.10 at nu=0.3 and "
                "looks like a 10% mesh error. (Audit 2026-08-03.)"
            ),
        ],
    },
}
