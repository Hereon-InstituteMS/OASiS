    ...
    "stokes": {
        ...
        "required_vs_optional": {
            "REQUIRED": [
                ...
                "relative error, against 1150-37167 iterations and "
                "~1e-10 for cg/gmres/bicgstab on the same problem",
        ...
        "pitfalls": [
            ...
            (
                ...
                "linear_iterations 1 and relative L2 error 9.5e-16, "
                "while solver='cg' converged in 1150 linear "
                "iterations to 4.2e-11, 'gmres' in 2527 to 2.8e-10 "
                "and 'bicgstab' in 37167 to 1.5e-10; with an explicit "
                "'linear.preconditioning.method' of 'none' gmres "
                "needed 70941 and with 'ssor' 6351. So the detector "
