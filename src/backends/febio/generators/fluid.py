    ...
    "fluid": {
        ...
        "pitfalls": [
            (
                ...
                "rejects with [FALSIFIED 2026-08-03: the message text "
                ...
                "executed. EXECUTED INSTEAD 2026-08-03: a `fluid` "
                "material inside a `solid` module is really "
                "rejected with `tag \"material\" (line N) : "
                "invalid value for attribute \"type\"` and "
                "`Reading file ...FAILED!`] "
                "Original unverified text: `material type fluid not allowed in "
            ...
            (
                ...
                "<x_dof>1</x_dof> on a fluid module is rejected at "
                "parse with `tag \"x_dof\" (line N) : unrecognized "
                "tag` and `Reading file ...FAILED!` (executed "
                "2026-08-03 on FEBio 4.12.0; the previously quoted "
                "`unknown BC parameter x_dof` does not occur "
                "anywhere in the binary or its libraries) — fluid "
                "uses w-prefixed DOFs to "
