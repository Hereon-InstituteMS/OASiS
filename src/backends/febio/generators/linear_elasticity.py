    ...
    "linear_elasticity": {
        ...
        "pitfalls": [
            ...
            (
                ...
                "...FAILED!` — this is the FIRST error hit by "
                "seven of the seventeen templates shipped in this "
                "backend. CORRECTED 2026-08-03 by re-running all "
                "17: the count is seven, not eight, and adding "
                "name= does NOT make any of the seven run — each "
                "then fails on a second, independent defect (see "
            ...
            (
                ...
                "kind, writes a non-empty MESH-ONLY .xplt (about "
                "15-30% smaller than the same deck solved; the "
                "absolute byte counts are deck-specific — 1354 vs "
                "1630 on one hex8 here, 1161 vs 1369 on the "
                "fixture deck — so compare against a solved run, "
