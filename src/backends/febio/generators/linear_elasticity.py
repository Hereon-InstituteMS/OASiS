    ...
    "linear_elasticity": {
        ...
        "pitfalls": [
            ...
            (
                ...
                "mat=\"1\" and with mat=\"M1\" on <Elements> both "
                "run and give bit-identical displacements). "
                "Signal: `tag \"SolidDomain\" (line N) : invalid "
                "value for attribute \"mat\"` with `Reading file "
                "...FAILED!`. Dropping <MeshDomains> entirely does "
                "NOT produce that message — the mesh is then never "
                "built and the first <bc> fails instead with "
                "`tag \"bc\" (line N) : invalid value for "
                "attribute \"node_set\"`, which sends you hunting "
                "in the wrong section. (Live-verified 2026-08-03, "
                "FEBio 4.12.0.)"
            ),
            (
            ...
            (
                ...
                "kind, writes a full-size .xplt plus every "
                "requested logfile CSV, and terminates. Signal: "
