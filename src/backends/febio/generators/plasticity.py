    ...
    "plasticity": {
        ...
        "pitfalls": [
            ...
            (
                ...
                "Signal: none — measure the residual stress after a full unload with <element_data data=\"sz\"/> on a load-then-unload history. Executed on two meshes at H/E = 0.001, 0.01, 0.1 and 1.0: the residual after returning the prescribed displacement to zero was LARGE at every ratio and was NOT smallest at H/E = 1 — it was non-monotone in H, with the largest residual at an intermediate ratio. Both meshes agreed. "
                "(Executed 2026-08-03, FEBio 4.12.0.86045466d. This FALSIFIES the previous claim that H ~ E gives \"near-elastic (small permanent strain)\".)"
            ),
            (
