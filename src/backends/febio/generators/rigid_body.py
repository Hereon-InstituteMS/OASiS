    ...
    "rigid_body": {
        ...
        "pitfalls": [
            (
                ...
                "on rigid body node — use Rigid section` [FALSIFIED "
                "2026-08-03: the message text quoted here does not occur "
                ...
                "and was NOT executed] or the BC "
            ...
            (
                ...
                "rigid_displacement BC raises [FALSIFIED 2026-08-03: the "
                "message text quoted here does not occur anywhere in the "
                "FEBio 4.12.0.86045466d binary or any of its shared "
                "libraries (`strings` over febio4 + all 12 .so files, "
                "267541 strings), so this Signal can never match on "
                "4.12. The physics reasoning is desk research and was "
                "NOT executed] `invalid rigid DOF "
            ...
            (
                ...
                "body simulation aborts with [FALSIFIED 2026-08-03: the "
                "message text quoted here does not occur anywhere in the "
                "FEBio 4.12.0.86045466d binary or any of its shared "
                "libraries (`strings` over febio4 + all 12 .so files, "
                "267541 strings), so this Signal can never match on "
                "4.12. The physics reasoning is desk research and was "
                "NOT executed] `rigid body N missing "
