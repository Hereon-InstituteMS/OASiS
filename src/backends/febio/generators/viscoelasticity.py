    ...
    "viscoelasticity": {
        ...
        "pitfalls": [
            ...
            (
                ...
                "Signal, for the part that was executed: refining the TIME STEP alone does not change the answer, which is the reassuring half. On two meshes, sweeping the step count over a factor of eight at fixed t_end changed the final relaxed stress only in the seventh significant digit while the peak moved in the fourth — so the scheme is converged in time at ordinary step counts, and a discrepancy larger than that between two runs of the same history is NOT step-size error and should be investigated as a state-handling problem. "
