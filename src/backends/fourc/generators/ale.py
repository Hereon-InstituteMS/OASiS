        ...
        return {
            ...
            "pitfalls": [
                (
                    ...
                    "for an ALE mesh raises 'expected ALE "
                    "element type' from 4C_ale_factory.cpp; "
                ...
                (
                    ...
                    "(ELAST_CoupLogNeoHooke). Signal: a "
                    "linear StVenantKirchhoff material on a "
                    "mesh rotating > 30° produces INVERTED "
                    "elements (det(J) < 0) — 4C aborts with "
                    "'negative Jacobian'. The log-strain "
                    "neo-Hookean variant remains "
                    "well-defined for arbitrary rotations. "
                    "(Audit 2026-06-02.)"
                ),
                (
                    ...
                    "but control how mesh stiffness is "
                    "distributed. Signal: using realistic E "
                    "and nu values (e.g. steel) makes the "
                    "ALE mesh too stiff and prevents "
                    "geometry tracking; very soft pseudo-"
                    "material lets the mesh distort "
                    "excessively. Tune YOUNG / NUE for mesh "
                    "quality, not physics. (Audit "
                    "2026-06-02.)"
                ),
                (
                    ...
                    "Signal: using CLONING MATERIAL MAP in a "
                    "stand-alone ALE input has no fluid "
                    "field to clone from — setup fails with "
                    "'source field not found'. Conversely, "
                    "skipping CLONING in FSI gives no ALE "
                    "discretisation. (Audit 2026-06-02.)"
                ),
                (
                    "[API] Result discretisation name is "
                    "'ale' (lowercase) in RESULT "
                    "DESCRIPTION. Signal: writing "
                    "'ALE' (uppercase) or 'Ale' (mixed) "
                    "raises 'discretisation ALE not found' "
                    "in the RESULT DESCRIPTION block — "
                    "4C is case-sensitive on field names. "
                    "Use lowercase 'ale' consistently. "
                    "(Audit 2026-06-02.)"
                ),
            ],
            "typical_experiments": [
