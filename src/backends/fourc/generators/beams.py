        ...
        return {
            ...
            "pitfalls": [
                ...
                (
                    ...
                    "a wrong NUMDOF is caught by "
                    "the DOF-count check, whose template is "
                    "'{} DOFs given but {} expected in {}' -- for example "
                    "'3 DOFs given but 6 expected in Point Dirichlet "
                    "boundary condition'. Verified by execution on a "
                    "BEAM3R LINE2 deck; the older wording 'inconsistent DOF "
                    "count for beam element' is NOT a string the binary "
                    "contains. Always match NUMDOF to the BEAM3R "
                    "configuration. (Audit 2026-06-02.)"
                ),
                (
                ...
                (
                    ...
                    "Signal: enabling HERMITE_CENTERLINE on "
                    "BEAM3R without increasing NUMDOF from 6 "
                    "to 9 produces an under-DOF'd element — "
                    "the tangent DOFs are silently allocated "
                    "but DESIGN ... DIRICH BCs with NUMDOF=6 "
                    "leave them free, and you get spurious "
                    "tangent growth at constrained nodes. "
                    "Match NUMDOF to HERMITE_CENTERLINE "
                    "choice. (Audit 2026-06-02.)"
                ),
                (
