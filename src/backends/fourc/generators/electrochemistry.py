        ...
        return {
            ...
            "pitfalls": [
                ...
                (
                    ...
                    "electrolyte flow). Signal: SUPG on a "
                    "pure-diffusion ELCH problem damps "
                    "physical concentration gradients by "
                    "5-20% — the BV current is "
                    "under-predicted. For natural "
                    "convection (Re ~ 1), keep "
                    "no_stabilization; for forced flow add "
                    "SUPG. (Audit 2026-06-02.)"
                ),
            ],
            "typical_experiments": [
                {
