        ...
        return {
            ...
            "pitfalls": [
                ...
                (
                    ...
                    "Signal: Galerkin discretisation "
                    "without SUPG/GLS on a fluid-scatra "
                    "field at Pe > 10 shows visible "
                    "oscillations downstream of source/"
                    "sink locations that do NOT damp with "
                    "refinement; adding SUPG removes them. "
                    "Use STABTYPE: residual_based with "
                    "DEFINITION_TAU: Codina-typical "
                ...
                (
                    ...
                    "the ALE velocity. Signal: NA: Euler "
                    "on FS3I fluid elements raises 'fluid "
                    "kinematic type incompatible with "
                    "moving-mesh scalar transport' at "
                    "setup; without it, the convective "
                    "term sees Eulerian velocity but the "
                    "mesh is moving, producing a spurious "
                    "O(|v_mesh|) error in the scalar "
                    "transport. 4C handles ALE-scatra "
                    "automatically when NA: ALE is set on "
                    "the fluid elements. (Audit "
                    "2026-06-02.)"
                ),
                (
