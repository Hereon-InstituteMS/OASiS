        ...
        return {
            ...
            "pitfalls": [
                (
                    ...
                    "candidate list running to well over a thousand "
                    "lines, one block per material 4C knows, each "
                    "re-echoing your MAT_ParticleDEM entry under \"The "
                    "following data remains unused\". No line anywhere in "
