        ...
        return {
            ...
            "pitfalls": [
                ...
                (
                    ...
                    "Signal: m = 2 produces stress fields "
                    "off the analytic elasticity solution "
                    "by 10-20%; m = 3 hits 1-3% error, "
                    "m = 4 reaches < 1%. The delta-"
                    "convergence requires m -> infinity, "
                    "but m = 3-4 is the practical sweet "
                    "spot. (Audit 2026-06-02.)"
                ),
                (
                ...
                (
                    ...
                    "Signal: a bond-based PD problem at "
                    "nu != these fixed values runs but the "
                    "resulting Poisson contraction matches "
                    "0.25 (2D) or 0.33 (3D) regardless of "
                    "the input nu. Use state-based PD if "
                    "you need arbitrary Poisson ratios. "
                    "(Audit 2026-06-02.)"
                ),
                (
