        ...
        return {
            ...
            "pitfalls": [
                ...
                (
                    ...
                    "result-test manager, not at setup. A deck that "
                    "result-tests QUANTITY 'temperature' without "
                    "TEMPERATUREEVALUATION runs the entire time loop and "
                    "then stops with 'state 'temperature' not found in "
