    ...
    def get_knowledge(self) -> dict[str, Any]:
        return {
            ...
            "pitfalls": [
                ...
                (
                    "[Numerical] Airway wall compliance "
                    "strongly affects pressure wave "
                    "propagation. Rigid airways (compliance "
                    "= 0) give a simpler problem but miss "
                    "physiological airway collapse and "
                    "reopening. Signal: a rigid-airway "
                    "model under high resistive load fails "
                    "to show the expected collapse "
                    "instability — pressure inside the "
                    "compliant airway should drop below "
                    "atmospheric and the lumen collapses. "
                    "Use COMPLIANCE in MAT_redAirway. "
                    "(Audit 2026-06-02.)"
                ),
                (
                    "[Numerical] Reduced model assumes LONG "
                    "WAVELENGTH (Womersley number "
                    "restrictions, Wo < O(1)). For high-"
                    "frequency ventilation a full 3D CFD "
                    "approach may be needed instead. "
                    "Signal: HFOV (high-frequency "
                    "oscillatory ventilation) at "
                    "Wo > 5 violates the 1D approximation "
                    "— pressure profiles in the trachea "
                    "differ from 3D CFD by 10-30%. Check "
                    "Wo = R * sqrt(omega / nu) before "
                    "trusting reduced-model results. "
                    "(Audit 2026-06-02.)"
                ),
                (
                    "[Input] Material properties VARY BY "
                    "AIRWAY GENERATION. Proximal airways "
                    "(trachea, bronchi: gen 0-3) have "
                    "stiffer walls and larger radii than "
                    "distal airways (bronchioles: gen "
                    "10+). Signal: using a single uniform "
                    "MAT_redAirway across all 16+ "
                    "generations gives wrong impedance "
                    "spectrum — total-airway-resistance "
                    "off by 2-5x vs measured. Specify a "
                    "different MAT_redAirway per "
                    "generation (or per element). (Audit "
                    "2026-06-02.)"
                ),
                (
