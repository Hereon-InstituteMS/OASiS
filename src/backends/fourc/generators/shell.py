        ...
        return {
            ...
            "pitfalls": [
                (
                    ...
                    "formulation. Signal: a C0 Lagrange "
                    "Kirchhoff element produces wrong "
                    "deflection by ~30-50% on plate "
                    "bending; the shear strain that the "
                    "C0 element cannot suppress contaminates "
                    "the bending energy. Use NURBS or DKT. "
                    "(Audit 2026-06-02.)"
                ),
                (
