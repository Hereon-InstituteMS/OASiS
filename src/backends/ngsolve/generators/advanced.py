    ...
    "phase_field": {
        ...
        "pitfalls": [
            ...
            (
                ...
                "not with a line search and not with load "
                "continuation over several substeps — while "
                "staggered converges in the usual 5-20 outer "
                "iterations, each cheaper (two linear solves "
                "instead of one nonlinear). The two DO agree, but "
            ...
            (
                ...
                "split at all; it stays far above a 1e-3 bound, so "
                ...
                "reduced but still orders of magnitude above "
