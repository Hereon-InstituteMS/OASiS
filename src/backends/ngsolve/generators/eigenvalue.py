...
KNOWLEDGE = {
    "eigenvalue": {
        ...
        "pitfalls": [
            ...
            "in the null space (see the maxwell entry and the "
            "arnoldi_shift_zero_singular Tier-2 fixture); on the "
            "Dirichlet Laplacian, shift=0 completed without any "
            "error on unit_square at (maxh=0.2, order=1), "
            "(maxh=0.1, order=2) and (maxh=0.05, order=2). "
            "(Family-verified via maxwell#5; the shift=0-is-safe "
            "half verified empirically 2026-08-03 on NGSolve "
            "6.2.2604.)",
