...
KNOWLEDGE = {
    "heat": {
        ...
        "pitfalls": [
            ...
            "CAVEAT (verified 2026-08-03): the warning is gated on "
            "ngsglobals.msg_level — at the default level it fires, "
            "but at msg_level <= 1 (which generated scripts often "
            "set to keep logs clean) NOTHING is printed and the "
            "kwarg is dropped in complete silence. Never rely on "
            "the warning as your only detector. (Verified "
            "empirically 2026-06-01 — drift correction; "
            "msg_level gating added 2026-08-03; the generator "
            "template above also dropped the kwarg.)",
