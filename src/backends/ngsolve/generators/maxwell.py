...
KNOWLEDGE = {
    "maxwell": {
        ...
        "pitfalls": [
            ...
            "Assemble. Signal (verified 2026-06-01): NgException "
            "with text 'real Evaluate called for complex ScaleCF' "
            "from 'Assemble BilinearForm'. The original catalog "
            "wording referenced 'complex values cannot be assigned "
            "to a real FESpace' — that text does not appear in "
