...
KNOWLEDGE = {
    "stokes": {
        ...
        "pitfalls": [
            ...
            "MinRes/GMRES. (Verified empirically "
            "2026-08-03 on NGSolve 6.2.2604 + scipy 1.15.3 — "
            "catalog-drift correction; the unconditional "
            "'CONVERGED in every configuration tried' claim was "
            "falsified in the 2026-08-03 adversarial re-audit.)",
