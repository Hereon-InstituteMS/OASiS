...
KNOWLEDGE: dict = {
    "hydraulic_resistance": {
        ...
        "pitfalls": [
            ...
            "extra is a couple of percent — measured 2026-08-03 "
            "on skfem 12.0.1 by running the shipped "
            "hydraulic_resistance_2d template unchanged (L=2.0, "
            "H=0.1, mu=1.0, p_in=1.0, n_dofs_u=2106, "
            "n_dofs_p=287): Q = 4.100936e-05, R_fe = 2.438468e+04 "
            "against R_exact = 2.400000e+04, relative error "
            "1.60e-02. The prior '~5% at L/H = 20' overstated it "
            "by 3x; treat >5% at L/H = 20 as a bug, not as "
            "entrance physics. For L/H = 2 the extra is ~50%. "
            "Signal: `relative_error` in results_summary.json is "
            "2-50% (rises as L/H shrinks) rather than the 0.1-1% "
            ...
            "MeshTri().refined(2..4): Taylor-Hood "
            "ElementVector(ElementTriP2()) + ElementTriP1 gives "
            "velocity L2 errors 2.968e-04 / 3.635e-05 / "
            "4.456e-06, i.e. rates 3.03 and 3.03 = k+1 for k=2, "
            "with the pressure L-inf error dropping 1.20e-02 / "
            "2.09e-03 / 3.02e-04. Swapping velocity to "
