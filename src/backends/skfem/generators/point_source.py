...
KNOWLEDGE: dict = {
    "point_source": {
        ...
        "pitfalls": [
            ...
            "against an r=8 reference projected onto each mesh: "
            "L2 error 3.382e-03 / 1.596e-03 / 7.737e-04 / "
            "3.294e-04 (ratios 2.12 / 2.06 / 2.35 per halving, "
            "so order ~1) while the H1-seminorm error is "
            "6.857e-02 / 6.741e-02 / 6.602e-02 / 5.405e-02 — "
            "essentially FLAT over an 8x refinement. Both halves "
            "of the claim confirmed. (Verified empirically "
            "2026-08-03.)",
