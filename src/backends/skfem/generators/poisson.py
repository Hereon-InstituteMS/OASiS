...
KNOWLEDGE = {
    "poisson": {
        ...
        "pitfalls": [
            ...
            "[Numerical] GAP FILLED 2026-08-03 — element order "
            "vs L2 convergence rate is now measured, not "
            "assumed. MMS with u = sin(pi x) sin(pi y), "
            "f = 2 pi^2 sin sin, homogeneous Dirichlet, on "
            "MeshTri().refined(r) for r = 2..5 with "
            "intorder=2*deg+3: ElementTriP1 L2 errors "
            "7.909e-02 / 2.113e-02 / 5.377e-03 / 1.350e-03 "
            "(rates 1.90, 1.97, 1.99); ElementTriP2 "
            "4.330e-03 / 5.481e-04 / 6.874e-05 / 8.601e-06 "
            "(rates 2.98, 3.00, 3.00); ElementTriP3 "
            "3.364e-04 / 2.000e-05 / 1.216e-06 / 7.502e-08 "
            "(rates 4.07, 4.04, 4.02). L2 order deg+1 confirmed "
            "for deg = 1, 2, 3. Signal: measure the error with "
            "a @Functional on a Basis built with an EXPLICIT "
            "intorder — the default 2*maxdeg under-integrates a "
            "transcendental error integrand and can cost you an "
            "apparent order. (Verified empirically 2026-08-03 "
            "on skfem 12.0.1.)",
        ],
    },
}
