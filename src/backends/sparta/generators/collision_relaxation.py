...
KNOWLEDGE = {
    "collision_relaxation": {
        ...
        "pitfalls": [
            ...
            "same run. 'collide_modify vibrate discrete' alone does NOT "
            "change that on a species file without discrete vibrational-level "
            "data; 'collide_modify vibrate smooth' does. "
            "Signal: a Tvib column that is exactly 0.0 on every stats line "
            "while the Trot column moves — rc = 0, no warning.",
