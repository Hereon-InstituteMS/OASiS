...
KNOWLEDGE = {
    "collision_relaxation": {
        ...
        "pitfalls": [
            ...
            "seeds the mode from the mixture's tvib at creation, so Tvib is "
            "nonzero from step 0. 'collide_modify vibrate discrete' is NOT the "
            ...
            "not stay there — collisions populate the levels (measured on "
            "co2.species N2: Tvib 0 at steps 0 and 100, 2.9262153 at step "
            "200). Only a species with no vibrational mode at all reads "
