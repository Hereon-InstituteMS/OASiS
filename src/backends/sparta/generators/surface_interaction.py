...
KNOWLEDGE = {
    "surface_interaction": {
        ...
        "pitfalls": [
            ...
            "and read it with 'read_surf <file> clip'. "
            ...
            "under the same name — eleven example directories contain a file "
            "called 'data.circle' and one of them is a completely different "
            "body. A deck that says 'read_surf data.circle' can therefore be "
            "handed a surface that does not fit its box. "
