...
def _fsi() -> str:
    ...
    return (
        ...
        "A FEniCSx structure with the same contract ships as "
        "`participant_fsi_solid_fenics.py` in the same directory; running the "
        "pair once with each is how you find out whether an answer depends on "
        "one structure code.\n\n"
        "## Wiring them\n\n"
